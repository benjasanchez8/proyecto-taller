...
export class VehiculoRevisionController {
  ...
  async find(
    ...
    return this.vehiculoRepository.puede_tener(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.puede_tener(id).create(revision);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.puede_tener(id).patch(revision, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.puede_tener(id).delete(where);
  }
}
